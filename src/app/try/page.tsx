...
const PLANT_LIST = [
  "Tomato", "Lettuce", "Pepper", "Carrot", "Sunflower", "Rose", "Cucumber",
  "Runner Bean", "Potato", "Strawberry", "Basil", "Sweet Pea", "Courgette",
  "Pumpkin", "Squash", "Beetroot", "Radish", "Parsley", "Mint", "Thyme",
  "Rosemary", "Sage", "Chive", "Dill", "Coriander", "Lavender", "Foxglove",
  "Dahlia", "Petunia", "Marigold", "Pansy", "Poppy", "Geranium",
  "Chrysanthemum", "Daffodil", "Tulip", "Bluebell", "Snowdrop", "Onion",
  "Garlic", "Leek", "Pea", "Broad Bean", "French Bean", "Sweetcorn",
  "Cabbage", "Broccoli", "Cauliflower", "Spinach", "Kale", "Spring Onion",
  "Rhubarb", "Raspberry", "Blackberry", "Gooseberry", "Apple", "Plum", "Cherry",
];
